...
* Сбор метрик работы приложения в Promtheus и дашборды на основе метрик Prometheus в Grafana.  
...
При помощи [Prometheus](./prometheus.yml) обеспечивается сбор статистики количества запросов к приложению и задержки ответов.  
